...
${OBJECTDIR}/Assignment1_Code.o: Assignment1_Code.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Assignment1_Code.o Assignment1_Code.c
